...
var CoffeeSprites, Image, Sprite, async, canvas, fs, instance, path, sprite_count;
...
Sprite = (function() {
  ...
  Sprite.prototype.render = function(callback) {
    var flow, key, sprite, _fn;
    sprite = this;
    if (sprite.width < 1) {
      return callback("sprite map was created but no images added");
    }
    if (fs.existsSync(sprite.digest_file())) {
      return callback("no change would occur");
    }
    ...
    flow["finally"](function() {
      var file, files, out, pattern, stream, _i, _len;
